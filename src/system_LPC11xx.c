...
#define SYSOSCCTRL_ByPASS_Enabled_Val        0x00000002
#define WDTOSC_SETUP          0
#define WDTOSCCTRL_Val        0x000000A0
#define SYSPLLCLKSEL_Val      0x00000001
#define SYSPLLCLKSEL_IRCVal      0x00000000
...
void SystemInit (void)
{
  ...
  LPC_SYSCON->SYSOSCCTRL    = SYSOSCCTRL_Val; // SYSOSCCTRL_ByPASS_Enabled_Val; //SYSOSCCTRL_Val;
  for (i = 0; i < 200; i++) __NOP();
  LPC_SYSCON->SYSPLLCLKSEL  = SYSPLLCLKSEL_IRCVal; //SYSPLLCLKSEL_Val;   /* Select PLL Input         */
